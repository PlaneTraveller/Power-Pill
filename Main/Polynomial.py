...
model=pipeline.make_pipeline(PolynomialFeatures(28),linear_model.LinearRegression())
with open('C:\Git\Power-Pill\Main\oldOut\California.csv') as csv:
...
date_train,date_test,case_train,case_test=train_test_split(date,case,test_size=0.3)
